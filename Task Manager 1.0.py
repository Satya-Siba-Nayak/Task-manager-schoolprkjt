...
# Add initial users
task_manager.add_user("Satya", "123", Role.ADMIN)
task_manager.add_user("Hrugved", "123", Role.ADMIN)
task_manager.add_user("Samarth", "123", Role.ADMIN)
task_manager.add_user("User", "123")  # Assigns default USER role
